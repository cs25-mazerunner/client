...
def update_map():
    if last_data['direction']is not None:
...
while True:
    ...
    if current_action == 'move/':
        ...
        if current_data['direction'] is not None and world_map[curr_room][current_data['direction']] != '?':
        ...
        if current_data.get('confirm', None) is None:
